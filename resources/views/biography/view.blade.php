    ...
    <div class="container-fluid bg-white p-0">
        ...
        <div class="container" style=" padding: 50px;">
            ...
            @foreach ($artists as $artist)
                <center> <img src="../{{ $artist->bioImageUrl }}" alt=""
                        class="img-thumbnail shadow-2-strong rounded mb-4">
                    <br>
                    <h5 class="post-date">Posted on: {{ $artist->created_at }}</h5><br>
                </center>
                <div class="post-body" style="background-color: #f2f2f2;  padding: 50px;">
                    {!! $artist->bioDetails !!}
                </div>
            @endforeach
            ...
            @forelse ($comments as $comment)
                <div class="well">
                    <h5>{{ $comment->comments }}; > [by <strong><i>{{ $comment->commentedBy }}</i></strong>]
                    </h5>
                </div>
            @empty
            ...
            <form action="{{ url('add-comment') }}" method="POST">
                ...
                <div class="form-group">
                    <label>Name</label>
                    <input type="text" name="commentedBy" class="form-control">
                </div>
                <div class="form-group">
                    <label>Email</label>
                ...
                <center class="form-group">
                    <button class="btn btn-block btn-lg btn-primary" type="submit">Add Comment</button>
                </center>
            </form>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            &copy; <a class="border-bottom"
                                href="https://www.golaartiistootaoromoo.com">www.golaartiistootaoromoo.com</a>, <p>All
                                Right
                                Reserved.</p>


                            <p> Designed By</p> <a class="border-bottom"
                                href="mailto:fandishefugug@gmail.com">Fandishe
                                Fugug</a>
                        </div>
