            ...
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="/bio-list" class="nav-item nav-link active">Biography</a>
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-lg-4 col-sm-6 mb-5">
          <div class="card p-0 border-primary rounded-0 hover-shadow">
            <img class="card-img-top rounded-0" src="{{$bio->bioImageUrl}}" style="height: 250px;"alt="course thumb">
            <div class="card-body">
              <ul class="list-inline mb-2">
                <li class="list-inline-item"><i
                    class="ti-calendar mr-1 text-color"></i>{{$bio->created_at}}</li>
                <li class="list-inline-item"><a class="text-color" href="/biography/{{ $bio->bioforArstist }}">{{ $bio->bioforArstist }}</a>
                </li>
              </ul>
              ...
              <a href="/biography/{{ $bio->bioforArstist }}" class="btn btn-primary btn-sm">Read More</a>
            </div>
          </div>
        </div>
        @endforeach
            ...
            <div class="container py-5 px-lg-5">
                <div class="row g-5">
                    <div class="col-md-6 col-lg-3">
                        ...
                        <p class="text-white"><i class="fa fa-map-marker-alt me-3 text-white"></i>Haramaya, Fugug, Oromia</p>
                        <p class="text-white"><i class="fa fa-phone-alt me-3 text-white"></i>+251924180914</p>
                        <p class="text-white"><i class="fa fa-envelope me-3 text-white"></i>golaartoromo@gmail.com</p>
                        <div class="d-flex pt-2">
                            ...
                            <a class="btn btn-outline-light btn-social text-white" href="https://t.me/golaartistootaoromoo"><i
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        <p class="text-white ml-3">Waa'ee Gola Artistoota Oromoo gara email keeysaanitin hordoofu dandeessu!</p>
