    ...
    <div class="container-fluid bg-white p-0">
        ...
        <div id="container" style=" padding: 50px;">
            ...
            @foreach ($posts as $post)
                <center><img src="../{{ $post->postImage }}" alt=""
                        class="img-thumbnail shadow-2-strong rounded mb-4">

                    <br>
                    <h5 class="post-date">Posted on: {{ $post->created_at }}</h5><br>
                </center>
                <div class="container post-body" style="background-color: #f2f2f2;  padding: 50px;">
                    {!! $post->postContent !!}
                </div>
                <br>
                <center><div class="embed-responsive embed-responsive-16by9 shadow-4-strong">
                    {!! $post->youtubeLink !!}
                </div></center>
            @endforeach
            ...
            <p>Add Comment</p>
            <hr>
            <form action="{{ url('add-post-comment') }}" method="POST">
                @csrf
